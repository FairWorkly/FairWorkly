...
public class CasualLoadingRuleTests
{
    ...
    public void Evaluate_CasualEmployee_WhenPaidAboveCasualRate_ShouldReturnNoIssues()
    {
        ...
        var payslip = CreatePayslip(EmploymentType.Casual, hourlyRate: 35.00m, hours: 20m, pay: 700.00m);
    ...
    public void Evaluate_CasualEmployee_WhenPaidAtPermanentRate_ShouldReturnCriticalIssue()
    {
        ...
        var payslip = CreatePayslip(EmploymentType.Casual, hourlyRate: 27.16m, hours: 20m, pay: 543.20m);
    ...
    public void Evaluate_CasualEmployee_WhenSignificantlyUnderpaid_ShouldReturnCriticalIssue()
    {
        ...
        var payslip = CreatePayslip(EmploymentType.Casual, hourlyRate: 25.00m, hours: 15m, pay: 375.00m);
    ...
    public void Evaluate_CasualEmployee_WhenSystemRateBelowMinimumButActualPayCorrect_ShouldReturnWarning()
    {
        ...
        var payslip = CreatePayslip(EmploymentType.Casual, hourlyRate: 30.00m, hours: 20m, pay: 679.00m);
    ...
    public void Evaluate_CasualEmployee_WhenWithinTolerance_ShouldReturnNoIssues()
    {
        ...
        var payslip = CreatePayslip(EmploymentType.Casual, hourlyRate: 33.94m, hours: 20m, pay: 678.80m);
    ...
    public void Evaluate_CasualEmployee_WhenJustOverTolerance_ShouldReturnCriticalIssue()
    {
        ...
        var payslip = CreatePayslip(EmploymentType.Casual, hourlyRate: 33.93m, hours: 20m, pay: 678.60m);
    ...
    public void Evaluate_CasualEmployee_DifferentLevels_ShouldUseCasualRate(int level, decimal expectedCasualRate)
    {
