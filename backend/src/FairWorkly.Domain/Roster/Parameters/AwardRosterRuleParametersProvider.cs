...
public sealed class AwardRosterRuleParametersProvider : IRosterRuleParametersProvider
{
    ...
    /// </summary>
    private static readonly RosterRuleParameterSet RetailAward = new(
    ...
    /// </summary>
    private static readonly RosterRuleParameterSet HospitalityAward = new(
        MinShiftHoursFullTime: 0m,
        MinShiftHoursPartTime: 3m,
        MinShiftHoursCasual: 3m,
        MealBreakThresholdHours: 5m,
    ...
    /// </summary>
    private static readonly RosterRuleParameterSet ClerksAward = new(
        MinShiftHoursFullTime: 0m,
        MinShiftHoursPartTime: 3m,
        MinShiftHoursCasual: 3m,
        MealBreakThresholdHours: 5m,
