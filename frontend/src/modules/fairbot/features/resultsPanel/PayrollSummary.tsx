...
import type { PayrollSummaryData } from '../../types/fairbot.types'
    ...
    return (
        <SummaryCard>
            <Stack spacing={FAIRBOT_RESULTS_UI.STAT_GAP}>
                <Typography variant="h6">{FAIRBOT_LABELS.PAYROLL_SUMMARY_TITLE}</Typography>
                <StatsGrid>
                    <StatCard>
                    ...
                    <StatCard>
                        <Typography variant="overline">{FAIRBOT_LABELS.TOTAL_RECORDS_LABEL}</Typography>
                        <Typography variant="h5">{data.totalRecords ?? FAIRBOT_NUMBERS.ZERO}</Typography>
                    </StatCard>
                </StatsGrid>
            </Stack>
            ...
            {hasIssues ? (
                ...
                <Alert severity="success">{FAIRBOT_LABELS.NO_PAYROLL_ISSUES}</Alert>
            )}
