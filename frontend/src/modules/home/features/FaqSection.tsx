...
const FAQ_MESSAGES: Record<string, FaqMessage> = {
  systems: {
    ...
    answer:
      "**FairWorkly doesn't require integration.** We accept **CSV** for payroll and **XLSX** for rosters, which means you can use any payroll or rostering system that can export these formats — including Xero, MYOB, QuickBooks, Keypay, Deputy, Tanda, and many others.",
  ...
  rostering: {
    ...
    answer:
      'No! While we work great with Deputy and Tanda exports, you can also upload roster data from Excel. We provide a **free template** that makes it easy to convert your existing schedules to XLSX format.',
  },
  awards: {
  ...
  validationTime: {
    ...
    answer:
      'Most validations complete in **2-3 minutes**. Upload your file, grab a coffee, and your compliance report will be ready. Larger files (100+ employees) may take up to 5 minutes.',
  },
  contracts: {
    question: 'Do you generate employment contracts?',
    answer:
      "No, we don't generate documents in the MVP. Our **Document Agent** helps you **track mandatory documents** like Fair Work Information Statement (FWIS), Separation Certificates, and Casual Conversion Notices — ensuring you don't miss critical deadlines.",
  },
  issues: {
    question: 'What if I find issues in my payroll?',
    answer:
      'We provide **detailed reports** with expected vs actual values and step-by-step recommendations. You can then fix issues in your payroll system (Xero/MYOB/etc) and re-upload to verify.',
  ...
  legal: {
    ...
    answer:
      '**No.** FairWorkly is a compliance validation tool, not legal advice. We check your payroll and rosters against Fair Work rules and highlight potential issues. For complex situations or disputes, consult the Fair Work Ombudsman or an employment lawyer.',
  },
  templates: {
    question: 'Do you provide file templates?',
    answer:
      'Yes! We provide **CSV templates** for payslip data and **XLSX templates** for roster data to help you get started with FairWorkly.',
  },
}
